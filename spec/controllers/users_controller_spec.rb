...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show microposts" do
      mp1 = Factory(:micropost, :user => @user, :content => "Hey now")
      mp2 = Factory(:micropost, :user => @user, :content => "Eating at Joe's Pizza")
      get :show, :id => @user
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      it "should clear password fields on failure" do
        @attr[:password] = "Test"
        @attr[:password] = "Tes"
        post :create, :user => @attr
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = {:name => "Joe User", :email => "user@example.com",
      ...
      it "should redirect to the root path for signed in user" do
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :email => "joe@test.com", :name => "Joe User",
                  :password => "joepwd", :password_confirmation => "joepwd"}
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should not allow delete self" do
        lambda do
